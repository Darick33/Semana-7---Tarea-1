...
export class FacturaService {
  apiurl = 'http://localhost/Sexto/gias2/Sexto/Proyectos/03MVC/controllers/factura.controller.php?op=';
  apiurl2 = 'http://localhost/Sexto/gias2/Sexto/Proyectos/03MVC/reports/factura.report.php';
  ...
  unoFactura(idFactura: number) {
    // Agregar idFactura como parámetro de consulta
    return this.lector.get(`${this.apiurl}?idFactura=${idFactura}`);
  }
